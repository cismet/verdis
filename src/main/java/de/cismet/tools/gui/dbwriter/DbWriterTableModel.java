...
public class DbWriterTableModel extends AbstractTableModel {
     ...
     */
    public DbWriterTableModel(final Vector actions) {
        insert = new javax.swing.ImageIcon(getClass().getResource(
                    "/de/cismet/tools/gui/dbwriter/res/new_table_row.png"));
        update = new javax.swing.ImageIcon(getClass().getResource(
                    "/de/cismet/tools/gui/dbwriter/res/update_table_row.png"));
        delete = new javax.swing.ImageIcon(getClass().getResource(
                    "/de/cismet/tools/gui/dbwriter/res/delete_table_row.png"));
    ...
    public Object getValueAt(final int rowIndex, final int columnIndex) {
        final Object o = actions.get(rowIndex);
        if (o instanceof SimpleDbAction) {
            final SimpleDbAction sda = (SimpleDbAction)o;
            switch (columnIndex) {
                case 0: {
                    switch (sda.getType()) {
