...
public class AenderungsanfrageTablePanel extends JPanel implements CidsBeanStore, EditModeListener {
    ...
    private void initComponents() {
        ...
        jToggleButton1.setToolTipText(org.openide.util.NbBundle.getMessage(AenderungsanfrageTablePanel.class, "AenderungsanfrageTablePanel.jToggleButton1.toolTipText")); // NOI18N
        jToggleButton1.setBorderPainted(false);
        jToggleButton1.setContentAreaFilled(false);
        jToggleButton1.setSelectedIcon(new javax.swing.ImageIcon(getClass().getResource("/de/cismet/verdis/res/own_rows.png"))); // NOI18N
