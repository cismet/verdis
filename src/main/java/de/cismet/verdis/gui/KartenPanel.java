...
public class KartenPanel extends javax.swing.JPanel implements FeatureCollectionListener,
    ...
    CidsBean kassenzeichenBean = null;
...
//        this.cmdNewPoint.setVisible(b);
    ...
    public void coordinatesChanged(final PNotification notification) {
        ...
        if (o instanceof SimpleMoveListener) {
            ...
            if ((pf != null) && (pf.getFeature() instanceof PostgisFeature) && (pf.getVisible() == true)
                ...
                CidsFeature cf = (CidsFeature) pf.getFeature();
                if (cf.getMetaClass().getName().toLowerCase().equals(VerdisMetaClassConstants.MC_FLAECHE.toLowerCase())) {
                    CidsBean cb = (CidsBean) cf.getMetaObject().getBean();

                    int kassenzeichenNummer = (Integer) getCidsBean().getProperty(KassenzeichenPropertyConstants.PROP__KASSENZEICHENNUMMER);
                    String bezeichnung = (String) cb.getProperty(RegenFlaechenPropertyConstants.PROP__FLAECHENBEZEICHNUNG);
                        ...
                        if ((one != null) && (joinCandidate != one)) {
                            ...
                            try {
                                ...
                                if ((one != null) && (two != null) && (one.getFeature() instanceof CidsFeature)
                                    ...
                                    int artOne = (Integer) cbOne.getProperty(RegenFlaechenPropertyConstants.PROP__FLAECHENINFO__FLAECHENART__ID);
                                    int artTwo = (Integer) cbTwo.getProperty(RegenFlaechenPropertyConstants.PROP__FLAECHENINFO__FLAECHENART__ID);

                                    int gradOne = (Integer) cbOne.getProperty(RegenFlaechenPropertyConstants.PROP__FLAECHENINFO__ANSCHLUSSGRAD__ID);
                                    int gradTwo = (Integer) cbTwo.getProperty(RegenFlaechenPropertyConstants.PROP__FLAECHENINFO__ANSCHLUSSGRAD__ID);
                                    ...
                                    Integer anteilOne = (Integer) cbOne.getProperty(RegenFlaechenPropertyConstants.PROP__ANTEIL);
                                    Integer anteilTwo = (Integer) cbTwo.getProperty(RegenFlaechenPropertyConstants.PROP__ANTEIL);
                                    ...
                                    String bemerkungOne = (String) cbOne.getProperty(RegenFlaechenPropertyConstants.PROP__BEMERKUNG);
                                    ...
                                    boolean sperreOne = cbOne.getProperty(RegenFlaechenPropertyConstants.PROP__SPERRE) != null && (Boolean) cbOne.getProperty(RegenFlaechenPropertyConstants.PROP__SPERRE);
                                    boolean sperreTwo = cbTwo.getProperty(RegenFlaechenPropertyConstants.PROP__SPERRE) != null && (Boolean) cbTwo.getProperty(RegenFlaechenPropertyConstants.PROP__SPERRE);
                                ...
                                if (one.getFeature() instanceof CidsFeature) {
                                    CidsFeature cfOne = (CidsFeature) one.getFeature();
                                    CidsBean cbOne = cfOne.getMetaObject().getBean();
    ...
    private static String getJoinBackupString(CidsBean flaecheBean) {
        String bezeichnung = (String) flaecheBean.getProperty(RegenFlaechenPropertyConstants.PROP__FLAECHENBEZEICHNUNG);
        String gr_grafik = Integer.toString((Integer)flaecheBean.getProperty(RegenFlaechenPropertyConstants.PROP__FLAECHENINFO__GROESSE_GRAFIK));
        String gr_korrektur = Integer.toString((Integer)flaecheBean.getProperty(RegenFlaechenPropertyConstants.PROP__FLAECHENINFO__GROESSE_KORREKTUR));
        String erfassungsdatum = ((Date)flaecheBean.getProperty(KassenzeichenPropertyConstants.PROP__DATUM_ERFASSUNG)).toString();
        String veranlagungsdatum = (String) flaecheBean.getProperty(RegenFlaechenPropertyConstants.PROP__DATUM_VERANLAGUNG);
        String sperre = Boolean.toString(flaecheBean.getProperty(RegenFlaechenPropertyConstants.PROP__SPERRE) != null && (Boolean)flaecheBean.getProperty(RegenFlaechenPropertyConstants.PROP__SPERRE));
        String bem_sperre = (String) flaecheBean.getProperty(RegenFlaechenPropertyConstants.PROP__BEMERKUNG_SPERRE);
        String feb_id = (String)flaecheBean.getProperty(RegenFlaechenPropertyConstants.PROP__FEB_ID);
        String bemerkung = (String) flaecheBean.getProperty(RegenFlaechenPropertyConstants.PROP__BEMERKUNG);
