...
//        }
     ...
     * @return  DOCUMENT ME!
     */
    private Collection<Feature> fetchFeaturesAllgemein(final CidsBean cidsBean, final boolean editable) {
     ...
     * @return  DOCUMENT ME!
     */
    private Collection<Feature> fetchFeaturesRegen(final CidsBean cidsBean, final boolean editable) {
        final ArrayList<Feature> featureCollection = new ArrayList<Feature>();
