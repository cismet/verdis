 ...
 */
public class LayerViewKassenzeichenGeometrienRuleSet extends DefaultAttributeTableRuleSet {

    //~ Methods ----------------------------------------------------------------

    @Override
    public Class<? extends FeatureServiceFeature> getFeatureClass() {
        return KassenzeichenGeometrienFeature.class;
    }
     ...
     * @version  $Revision$, $Date$
     */
    public static class KassenzeichenGeometrienFeature extends CidsLayerFeature {
         ...
         */
        public KassenzeichenGeometrienFeature(final CidsLayerFeature feature) {
            super(feature);
        }
         ...
         */
        public KassenzeichenGeometrienFeature(
