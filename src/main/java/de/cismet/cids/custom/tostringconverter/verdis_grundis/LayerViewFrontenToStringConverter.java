 ...
 */
public class LayerViewFrontenToStringConverter extends CustomToStringConverter
    ...
    public String createString() {
        ...
        return String.format("Kassenzeichen: %s::%s", kassenzeichennummer, nummer);
    }
    ...
    public String featureToString(final Object feature) {
        if (feature instanceof CidsLayerFeature) {
            ...
            final String nummer = String.valueOf(cidsFeature.getProperty("nummer"));
            return String.format("Kassenzeichen: %s::%s", kassenzeichennummer, nummer);
        } else {
            return null;
        }
