 ...
 */
public class LayerViewFlaechenToStringConverter extends CustomToStringConverter
    ...
    public String createString() {
        ...
        final String bezeichnung = String.valueOf(cidsBean.getProperty("flaechenbezeichnung"));
        final String grad = String.valueOf(cidsBean.getProperty("anschlussgrad"));
        return String.format("Kassenzeichen: %s::%s - %s", kassenzeichennummer, bezeichnung, grad);
    }
    ...
    public String featureToString(final Object feature) {
        if (feature instanceof CidsLayerFeature) {
            ...
            final String bezeichnung = String.valueOf(cidsFeature.getProperty("flaechenbezeichnung"));
            final String grad = String.valueOf(cidsFeature.getProperty("anschlussgrad"));
            return String.format("Kassenzeichen: %s::%s - %s", kassenzeichennummer, bezeichnung, grad);
        } else {
            return null;
        }
