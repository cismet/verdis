...
public class TableSorter extends AbstractTableModel {
    ...
    public boolean isSorting() {
        return (sortingColumns.size() != 0) & !(((de.cismet.verdis.gui.FlaechenUebersichtsTableModel)tableModel).getTmpNoSort()) ;    
    }
    ...
    public void setColumnComparatorByColumn(int column, Comparator comparator) {
    ...
    protected Comparator getComparator(int column) {
        Integer key=new Integer(column);
        Object o=columnComparators.get(key);
        if (o!=null) {
            return (Comparator)o;
        }
        else {
